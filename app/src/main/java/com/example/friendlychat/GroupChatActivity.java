...
public class GroupChatActivity extends AppCompatActivity
{
    ...
    private String currentGroupName,currentUserId,currenUserName,currentDate,currentTime;
    ...
    private void saveMessageInfoToDatabase()
    {
        ...
        {
            Toast.makeText(GroupChatActivity.this,"Please Enter a message",Toast.LENGTH_LONG).show();
        }
        else
        {
