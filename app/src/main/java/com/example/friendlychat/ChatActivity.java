...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Picasso.with(this).load(messageReceiverImage).placeholder(R.drawable.profile_image).into(userImage);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 438 && resultCode == RESULT_OK && data != null && data.getData() != null)
        {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                messageBodyDetail.put(messageSenderRef + "/" + messagePushId, messageDocsBody);
                                messageBodyDetail.put(messageReceiverRef + "/" + messagePushId, messageDocsBody);
            ...
            {
                loadingBar.dismiss();
                Toast.makeText(ChatActivity.this,"Please Select an Image",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    {
        String saveRecentTime,saveRecentDate;
        Calendar calendar = Calendar.getInstance();

        SimpleDateFormat currentDate  = new SimpleDateFormat("dd MMM yyyy");
        saveRecentDate = currentDate.format(calendar.getTime());

        SimpleDateFormat currentTime  = new SimpleDateFormat("hh:mm a");
        saveRecentTime = currentTime.format(calendar.getTime());

        HashMap<String,Object> onlineStateMap = new HashMap<>();
        onlineStateMap.put("time",saveRecentTime);
        onlineStateMap.put("date",saveRecentDate);
